  ...
  <Layout>
    <main>
      <div class="content">
        ...
        <div class="heading-wrapper">
          <div class="heading">
            ...
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
              width="200px" height="200px" viewBox="0 0 800.000000 1200.000000"
        ...
        <div class="functions-heading">Funkcie</div>
        <ul>
          <li v-for="func in $page.project.functions" :key="func.id">
            {{ func }}
          </li>
        </ul>
        ...
        <ul>
          <li v-for="s in $page.project.stack" :key="s.id">
            {{ s }}
          </li>
        </ul>

        <div class="url-heading">Odkazy</div>
        <div class="urls">
          <a :href="$page.project.demo" class="link" target="_blank">Demo </a>
          <a :href="$page.project.git" class="link" target="_blank">GitHub</a>
        </div>
...
.functions-heading, .stack-heading, .url-heading {
  padding-top: 30px;
  padding-bottom: 5px;
  font-weight: 700;
}
