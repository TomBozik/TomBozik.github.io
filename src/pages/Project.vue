    ...
    <div class="content">
      ...
      <div class="heading">
        ...
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
          width="250px" height="250px" viewBox="0 0 1280.000000 1280.000000"
          preserveAspectRatio="xMidYMid meet" class="splash">
          <g transform="translate(50.000000,1100.000000) scale(0.100000,-0.100000)" fill="#5e5e5e" stroke="none">
      ...
      <div class="gallery-wrapper">
        <div class="gallery">
          <div v-for="project in $page.allProject.edges" :key="project.id" class="project">
            <a :href="project.node.path" class="project-link">
              <div class="project-description">
                <div class="project-title">
                  {{project.node.title}}
                </div>
                <div class="project-stack">
                  <div v-for="stack_item in project.node.stack_description" :key="stack_item.id" class="stack-item">
                    {{stack_item}}
                  </div>
                </div>
              </div>
    ...
    allProject {
      edges {
        node {
          ...
          path
          stack_description
          cover (width: 608, height: 430, fit: cover)
        }
      }
    }
  }
